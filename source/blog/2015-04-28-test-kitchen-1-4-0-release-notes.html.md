...
For a more in-depth example of getting started with Test Kitchen and Windows check out the [Windows Test Flight with Vagrant](../test-kitchen-windows-test-flight-with-vagrant) blog post.
